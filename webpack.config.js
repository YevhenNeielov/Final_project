...
const jsArr = [
  ...
  path.resolve(__dirname, "src/js/slick-slider.js"),
  path.resolve(__dirname, "src/js/leaflet.extra-markers.min.js"),
  path.resolve(__dirname, "src/js/leaflet.js"),
  path.resolve(__dirname, "src/js/smooth-scroll.min.js"),
